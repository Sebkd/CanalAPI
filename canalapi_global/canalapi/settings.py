"""
Django settings for canalapi_global project.
...
SECRET_KEY = 'django-insecure-&hng2v9s2rsc9+fgo7r-vq4z!umg9-$_bw#(or4s+#jt$hpy3c'
...
WSGI_APPLICATION = 'canalapi.wsgi.application'
